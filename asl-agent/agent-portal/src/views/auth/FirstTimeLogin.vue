...
<script>
/**
 * Description:This component is used when user get invitaion and first time want to login
 * This componnet helps user to set his password when he/she want to try login first time
 */
...
export default {
  ...
  methods: {
    ...
    setPassword() {
      ...
      this.loading = true;
      this.apiRequest("register", "agent", "POST", {
